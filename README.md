This is a [Laravel](https://00web.org/) project bootstrapped with `composer create-project 00web/00web 00web-wasmer-example` (with some minor adaptations for Wasmer).
